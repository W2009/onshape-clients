...
from onshape_client.oas.models import bt_metadata_response_info_ts
...
class MetadataApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __get_wmve_metadata(self, did, wvm, wvmid, eid, **kwargs):
            ...
            kwargs["_request_timeout"] = kwargs.get("_request_timeout", None)
            kwargs["_check_input_type"] = kwargs.get("_check_input_type", True)
            kwargs["_check_return_type"] = kwargs.get("_check_return_type", False)
            kwargs["_host_index"] = kwargs.get("_host_index", 0)
            kwargs["did"] = did
            kwargs["wvm"] = wvm
            kwargs["wvmid"] = wvmid
        ...
        self.get_wmve_metadata = Endpoint(
            settings={
                #"response_type": ("json",),   #bt_metadata_property_info.BTMetadataPropertyInfo
                "response_type":(
                     bt_metadata_response_info_ts.BTMetadataResponseInfo,
        ...
        self.get_wmvep_metadata = Endpoint(
            settings={
                #"response_type": None,
                "response_type":(bt_metadata_response_info_ts.BTMetadataResponseInfo,),
                "auth": ["OAuth2"],
